...
export class AppComponent {
  ...
  professor = [
    ...
    new Professor('Tadeu'),
    new Professor('Fabio'),
    new Professor('Fabiano'),
    new Professor('Paulo'),
  ]
  disciplinas = [
    new Disciplina(1,'Língua Portuguesa',Professor,'O objetivo norteador da BNCC de Língua Portuguesa ' +
    ...
    new Disciplina(2,'Educação Física',Professor, 'A Educação Física é o componente curricular ' +
    ...
    new Disciplina(3,'Inglês',Professor, 'Aprender a língua inglesa propicia a criação de novas ' +
    ...
    new Disciplina(4,'Matemática',Professor, 'No Ensino Fundamental, essa área, por meio da ' +
    ...
    new Disciplina(5,'Ciências',Professor, 'Ao estudar Ciências, as pessoas aprendem a respeito ' +
