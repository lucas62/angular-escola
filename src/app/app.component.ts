...
export class AppComponent {
  selecionado = null;
  disciplinas = [
    new Disciplina(1,'Língua Portuguesa',new Professor('Madia'),'O objetivo norteador da BNCC de Língua Portuguesa ' +
    ...
    new Disciplina(2,'Educação Física',new Professor('Tadeu'), 'A Educação Física é o componente curricular ' +
    ...
    new Disciplina(3,'Inglês',new Professor('Fabio'), 'Aprender a língua inglesa propicia a criação de novas ' +
    ...
    new Disciplina(4,'Matemática',new Professor('Fabiano'), 'No Ensino Fundamental, essa área, por meio da ' +
    ...
    new Disciplina(5,'Ciências',new Professor('Paulo'), 'Ao estudar Ciências, as pessoas aprendem a respeito ' +
